...
// node_modules/react-native-paper/src/components/CheckboxIOS.js  replace this file with this file (modified code )
...
class CheckboxIOS extends React.Component<Props> {
  ...
  render() {
    const { status, borderStyle, disabled, onPress, theme, ...rest } = this.props;
    ...
    return (
      <TouchableRipple
        ...
        style={borderStyle || styles.container}
      >
