  ...
  switch (action.type) {
    ...
    case SET_USER_DATA_FOR_PREPARATION:
      return {
        ...
        is_user_meet_doctor_before:
          action.data.is_user_meet_doctor_before ||
          initialState.is_user_meet_doctor_before,
        reason_for_visit:
          action.data.reason_for_visit || initialState.reason_for_visit,
        general_health_info: action.data.general_health_info,
        ...
        secondary_mobile:
          action.data.secondary_mobile || initialState.secondary_mobile,
