  ...
  render() {
    ...
    return (
      <View style={styles.container}>
        <View style={{ flex: 1,flexDirection:'column' ,height: 50, backgroundColor: '#9B65F0' }}>
        ...
        <View >
          ...
          <View style={styles.loginarea}>
            ...
            <View style={{ marginTop: 10 }} >
              <Text style={styles.name}>Kalki Coechlin</Text>
            </View>


            <View style={{ marginTop: 10 }}>
              <Text style={styles.email}>EMAIL ADDRESS</Text>
              <InputText placeholder={'Name or Email or Mobile'}></InputText>
            </View>

            <View style={{ marginTop: 10 }}>
              <Text style={styles.password}>PASSWOED</Text>
