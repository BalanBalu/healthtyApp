...
import { View, Text, CheckBox, Picker, DatePickerAndroid, TouchableHighlight, Image, TouchableOpacity } from 'react-native'
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.signuparea}>
          ...
          <Text style={styles.welcome}>SignUp To Join</Text>
          <Image
            style={styles.logo}
          ...
          <View style={{flex:1, flexDirection: 'column',textAlign:'center',marginTop: 7  }}>
          <View style={{flex:1,flexDirection:'row'}}>
            <TouchableOpacity onPress={this._showDateTimePicker}>
              <Image source={{ uri: 'http://heritageacademyschools.org/wp-content/uploads/2017/06/heritage_image_2.png' }} style={{ height: 40, width: 40 ,marginTop:2}} />
            </TouchableOpacity>
            <DateTimePicker
            ...
            <Text style={styles.date}> {this.state.selectedDOB}</Text>
          </View>
          </View>

          
          <View style={{ marginTop: 10 }}>
            <InputText style={styles.inputBox} underlineColorAndroid='transparent' placeholder={'Gender'}></InputText>
          </View>
          <View style={{ flexDirection: 'column' }}>
            ...
            <View style={{ flexDirection: 'row', marginTop: 10 }}>
              ...
              />
              <Text style={{ marginTop: 5 }}>I accept medflics terms and conditions</Text>
            </View>
          </View>
          ...
          <View>
            ...
            <Text style={{textAlign:'center',marginTop:10}} >Have An Account ? Sign In</Text>
          </View>
