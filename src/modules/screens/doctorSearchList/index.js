                                                            ...
                                                            <View>
                                                                ...
                                                                <View style={{ borderTopColor: '#000', borderTopWidth: 0.5, marginTop: 10 }}>
                                                                    ...
                                                                    <Text note style={{ fontSize: 12, fontFamily: 'OpenSans' }}>Selected Appointment on</Text>
                                                                        <Text style={{ color: '#000', fontSize: 12, fontFamily: 'OpenSans', marginLeft: -16,marginTop:5 }}>{selectedSlotItemByDoctorIds[item.doctorIdHostpitalId] ? formatDate(selectedSlotItemByDoctorIds[item.doctorIdHostpitalId].slotStartDateAndTime, 'ddd DD MMM, h:mm a') : null}</Text>
                                                                    </Col>
                                                                    <Col style={{ width: '35%' }}>
                                                                        </Col>
                                                                        <Col style={{ width: '25%' }}>
