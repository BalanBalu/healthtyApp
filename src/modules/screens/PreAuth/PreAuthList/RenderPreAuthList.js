                ...
                <Card style={{ padding: 10, borderRadius: 5, marginTop: 10 }}>
                    ...
                    <Row style={{ borderBottomColor: 'gray', borderBottomWidth: 0.3, paddingBottom: 10 }}>
                        ...
                        <Col size={9}>
                            <Row style={{ marginTop: 5, }}>
                                ...
                                <Col size={5.5}>
                                    <Text style={Styles.commonText}>{item.patientName || null}</Text>
                                </Col>
                            </Row>
                            <Row style={{ marginTop: 5, }}>
                                <Col size={4}>
                                ...
                                <Col size={5.5}>
                                    <Text style={Styles.commonText}>{item.referenceNumber || 'N/A'}</Text>
                                </Col>
                            </Row>
                            <Row style={{ marginTop: 5, }}>
                                <Col size={4}>
                                ...
                                <Col size={5.5}>
                                    <Text style={Styles.commonText}>{item.hospitalName || null}</Text>
                                </Col>
                            </Row>
                            <Row style={{ marginTop: 5, }}>
                                <Col size={4}>
                                ...
                                <Col size={5.5}>
                                    <Text style={Styles.commonText}>{item.hospitalLocation || null}</Text>
                                </Col>
                            </Row>
                        </Col>
                        <Col size={1}>
                    ...
                    <Row style={{ marginTop: 5 }}>
                        <Left>
                            ...
                            <Text style={Styles.boldText}>{item.createdDate ? formatDate(item.createdDate, 'DD/MM/YYYY') : null}</Text>
                        </Left>
                        <Right>
                            <TouchableOpacity style={Styles.ecardButton} onPress={() => navigation.navigate("DocumentList", { uploadData: item.patientProof, data: item, preAuthData: true })}>
