                ...
                <Content style={{ backgroundColor: '#F5F5F5', padding: 10 }}>
                    <View style={{ marginBottom: 30 }}>
                        ...
                        <View style={{ backgroundColor: '#fff', padding: 10, marginTop: 10 }}>
                            ...
                            <Text note style={styles.homeAdressTexts}>S.Mukesh Kannan</Text>
                        ...
                        <View style={{ backgroundColor: '#fff', padding: 10, marginTop: 10 }}>
                            ...
                            <Row style={{ marginTop: 10 }}>
                                ...
                                <Col size={8.5}>
                                    <Text style={styles.nameDetails}>Dr.pradeep natarajan</Text>
                                    <Text note style={styles.doctorDegreeText}>B.D.S.B.D.S Hearing Specialist</Text>
                                </Col>
                            </Row>
                            <Row style={{ marginTop: 5 }}>
                                <Col size={6}>
                                    <Text note style={styles.nameDetails}>Doctor Fees <Text style={{ fontFamily: 'OpenSans', fontSize: 10, color: '#8dc63f' }}>{" "}(2 persons) </Text></Text>
                                </Col>
                                <Col size={4}>
                                    <Text style={[styles.rightAmountText, { color: '#8dc63f' }]}>₹1000.00</Text>
                                </Col>
                            </Row>
                            <Row>
                                <Col size={6}>
                                ...
                                <Col size={4}>
                                    <Text style={styles.rightAmountText}>₹150.00</Text>
                                </Col>
                            </Row>
                            <Row>
                                <Col size={6}>
                                ...
                                <Col size={4}>
                                    <Text style={[styles.rightAmountText, { color: '#8dc63f' }]}>₹1150.00</Text>
                                </Col>
                            </Row>
                        </View>
                    </View>
                    ...
                    <FooterTab>
                        <Row>
                            <Col size={5} style={styles.totalAmount}>
                                <TouchableOpacity >
                                    <Text style={styles.totalAmountText}>Total - ₹1150</Text>
                                </TouchableOpacity>
                            </Col>
