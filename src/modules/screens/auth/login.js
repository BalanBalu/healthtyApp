...
class Login extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      showPassword: true,
      isSelected:
        CURRENT_APP_NAME === MY_SMART_HEALTH_CARE ? 'corporate_user' : 'user',
      CorporateUser: false,
    };
  }
  ...
  doLogin = async () => {
    ...
    try {
      ...
      if (this.props.user.isAuthenticated) {
        ...
        this.setState({
          loginErrorMsg: this.props.user.message,
          isModalVisible: true,
        });
      }
      ...
      this.setState({
        loginErrorMsg: 'Something Went Wrong' + e,
        isModalVisible: true,
      });
    }
  };
  ...
  getUserProfile = async (isSelected) => {
    try {
      if (isSelected === 'corporate_user') {
        ...
        let userId = await AsyncStorage.getItem('userId');
        let fields =
          'first_name,last_name,gender,dob,mobile_no,email,profile_image,middle_name';
        let result = await fetchUserProfile(userId, fields);
          ...
          <ImageBackground
            ...
            <View>
              <View style={styles.imageContainer}>
                <Svg
                  xmlns="http://www.w3.org/2000/Svgg"
                  width="55"
                  height="55"
                  viewBox="0 0 299.83 282.06">
                  <G
                    id="Layer_2"
                    data-name="Layer 2"
                ...
                <View>
                  <Text>
                    <Text style={styles.textBold}>MySmart</Text>
                    <Text
                      style={{fontFamily: 'opensans-regular', color: '#fff'}}>
                      Health
                    </Text>
                  </Text>
                </View>
          ...
          <View style={styles.inputContainer}>
            ...
            <Form>
              ...
              <Item
                style={{
                  marginTop: 40,
                  borderBottomColor: this.state.backgroundColor1,
                  borderBottomWidth: 1,
                  width: '88%',
                  marginRight: 50,
                  marginLeft: 30,
              ...
              <Item
                style={{
                  borderBottomColor: this.state.backgroundColor2,
                  borderBottomWidth: 1,
                  width: '88%',
                  marginRight: 50,
                  marginLeft: 30,
                ...
                <Input
                  ...
                  onSubmitEditing={() => {
                    (userEntry && password) != ''
                      ? this.doLogin()
                      : this.enterTextInputEmail._root.focus();
                  }}
                />

                {this.state.password !== '' && showPassword == true ? (
                  <Icon
                    active
                    name="eye"
                    style={{fontSize: 20, marginTop: 5, color: primaryColor}}
                ...
                <View
                  ...
                  <Radio
                    ...
                    onPress={() =>
                      this.setState({
                        isSelected: 'corporate_user',
                        addPatientDataPoPupEnable: true,
                        patientDetailsObj: {},
                      })
                    }
                  />
              ...
              <View
                ...
                <Text
                  ...
                  style={{marginTop: 20, color: '#AAAAAA'}}>
                  Forgot Password?
                </Text>
              </View>
            ...
            <LinearGradient
              ...
              style={[styles.createAccount, {marginBottom: 50}]}>
              <Pressable
