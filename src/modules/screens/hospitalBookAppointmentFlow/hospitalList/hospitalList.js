...
const hospitalBookAppointmentDataState = ({ hospitalBookAppointmentData, bookappointment } = state) => ({ hospitalBookAppointmentData, bookappointment })
export default connect(hospitalBookAppointmentDataState)(HospitalList)
