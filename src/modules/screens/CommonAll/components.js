  ...
  return (
    <View
      ...
      <View
        ...
        <Row style={{justifyContent: 'center'}}>
          <Col style={{width: '25%'}}>
            <Text
              ...
              {props.data.previous_data
                ? formatDate(
                    props.data.previous_data.appointment_date,
                    'DD/MM/YYYY',
                  )
                : null}
            </Text>
        ...
        <Row style={{justifyContent: 'center'}}>
          <Col style={{width: '30%'}}>
            <Text
              ...
              {formatDate(props.data.appointment_date, 'DD/MM/YYYY')}
            </Text>
          </Col>
          {/* <Col style={{ width: '70%' }}>
        ...
        <Row
          style={{marginTop: 15, justifyContent: 'flex-end', marginBottom: 15}}>
          <Col size={2}></Col>
          <Col size={8}>
            <Row>
              ...
              <Col size={3.4} style={{marginRight: 3}}>
                <TouchableOpacity
                  ...
                  onPress={() =>
                    props.onPressUpdateAppointmentStatus(props.data, 'APPROVED')
                  }
                  testID="confirmButton">
                  <Text
                    style={{
              ...
              <Col size={3.6}>
                <TouchableOpacity
                  ...
                  onPress={() => props.onPressNavigateToCancelAppointment()}
                  testID="cancelButton">
                  <Text
                    style={{
                      fontFamily: 'Roboto',
  ...
  return (
    <Card
      ...
      <Item style={{marginTop: '15%', borderBottomWidth: 0}}>
        <Button
          onPress={() => props.onPressGoToBookNow('BOOK_NOW')}
    ...
    <>
      ...
      <Row style={{justifyContent: 'center'}}>
        <Text style={styles.finalRs}>
          ₹{' '}
          {parseInt(props.priceInfo.branch_details.price) -
            (parseInt(props.priceInfo.branch_details.offer) / 100) *
              parseInt(props.priceInfo.branch_details.price)}
        </Text>
  ...
  return (
    <>
      ...
      <Text
        ...
        {props.offerInfo ? props.offerInfo : '0'}%
      </Text>
    </>
  );
};
    ...
    <>
      ...
      <View
        ...
        <Text
          style={
            props.isFromLabBookApp
              ? styles.ratingCount4LalBookApp
              : styles.ratingCount
          }>
          {props.totalRatingCount}
        </Text>
      </View>
    </>
  );
  ...
  return (
    <>
      <Text
        ...
        style={
          props.isFromLabBookApp
            ? styles.favoritesText4LalBookApp
      ...
      <Text
        style={
          props.isFromLabBookApp
            ? styles.favoritesCount4LalBookApp
...
const RenderFavoritesComponent = (props) => {
  return (
    <TouchableOpacity
      ...
      onPress={() => props.onPressFavoriteIcon()}>
      {props.isLoggedIn ? (
        <Icon
          name="heart"
          style={
            props.isEnabledFavorites
              ? props.isFromLabBookApp
                ? styles.isEnabledFavorite4LalBookApp
                : styles.isEnabledFavorite
              : props.isFromLabBookApp
              ? styles.isDisabledFavorite4LalBookApp
              : styles.isDisabledFavorite
          }></Icon>
      ) : null}
    </TouchableOpacity>
  );
...
const RenderEditingPincode = (props) => {
  const {
    value,
    onChangeSelection,
    isPincodeEditVisible,
    showPinCodeResultByType = 'Hospitals',
  } = props;
  return isPincodeEditVisible === false ? (
  ...
  return (
    <View style={{backgroundColor: '#fff', marginTop: 5}}>
      <Row>
        ...
        <Col size={5.5}>
          <Text style={[styles.beneficiaryFontStyle, {color: '#909498'}]}>
          ...
          <Text style={[styles.beneficiaryFontStyle, {color: '#909498'}]}>
            {data.enrollmentStartDate
              ? formatDate(data.enrollmentStartDate, 'DD/MM/YYYY')
              : null}
          </Text>
          <Text style={[styles.beneficiaryFontStyle, {color: '#909498'}]}>
            {data.enrollmentEndDate
              ? formatDate(data.enrollmentEndDate, 'DD/MM/YYYY')
              : null}
          </Text>
          <Text style={[styles.beneficiaryFontStyle, {color: '#909498'}]}>
            {data.sumInsured ? data.sumInsured : 0}
          </Text>
          <Text style={[styles.beneficiaryFontStyle, {color: '#909498'}]}>
            {data.balSumInsured ? data.balSumInsured : 0}
          </Text>
