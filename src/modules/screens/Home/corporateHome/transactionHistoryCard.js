...
export const TransactionHistoryCard = (props) => {
    ...
    const data = [{ category_name: 'Consultation', image: require('../../../../../assets/images/corporateHomePageIcon/consultation.png'), navigate: 'My Appointments' }, { category_name: 'Pharmacy', image: require('../../../../../assets/images/corporateHomePageIcon/pharmacy_a.png'), navigate: 'Medicines' }, { category_name: 'Home test', image: require('../../../../../assets/images/corporateHomePageIcon/home-test.png'), navigate: 'My Home Healthcare Appointments' }, { category_name: 'Hospital', image: require('../../../../../assets/images/corporateHomePageIcon/hospital_a.png'), navigate: 'HospitalList' }, { category_name: 'Lab test', image: require('../../../../../assets/images/corporateHomePageIcon/Lab-test.png'), navigate: 'Lab Test' }, { category_name: 'My Chats', image: require('../../../../../assets/images/corporateHomePageIcon/chat.png'), navigate: 'Video and Chat Service' }, { category_name: 'Video Consult', image: require('../../../../../assets/images/corporateHomePageIcon/video-consultation.png'), navigate: 'Video and Chat Service' },]
    return (
        <View>
