        ...
        try {
            ...
            if (upCommingAppointmentResult.success) {
                ...
                time.map((t) => {
                    ...
                    let currentDate = formatDate(new Date().toISOString(), "dddd,MMMM DD-YYYY")
                    var dateServerToHandleTomorrow = new Date(currentDate);
                    var tomorrow = new Date(dateServerToHandleTomorrow.setDate(dateServerToHandleTomorrow.getDate() + 1));
                    let tomorrowDate = formatDate(tomorrow.toISOString(), "dddd,MMMM DD-YYYY")
            ...
            <Container style={styles.container}>
                ...
                <Content keyboardShouldPersistTaps={'handled'} style={styles.bodyContent}>
                    ...
                    <View style={{ marginLeft: 10, marginRight: 10, marginBottom: 20 }}>
                        ...
                        <Row style={{ marginTop: 10, marginBottom: 5 }}>
                            <Left>
                                <Text style={styles.mainHead}>You have an Appointment on {updatedDate}</Text>
                            </Left>
                        </Row>
                        <Card style={{}}>
