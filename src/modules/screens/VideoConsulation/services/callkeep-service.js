...
import { IS_ANDROID, ANDROID_BUNDLE_IDENTIFIER, IS_IOS, ANDROID_VIDEO_CALL_ACTIVITY_NAME, CURRENT_APP_NAME } from '../../../../setup/config';
    ...
    displayIncomingCall = async (handleNumber, handlerName) => {
        ...
        if (AppState.currentState === 'active') {
            ...
            if (IS_ANDROID) {
                ...
                RNCallKeep.displayIncomingCall(this.uuid, String(handleNumber), CURRENT_APP_NAME + ' Doctor', 'generic', true);
            }
        }
    }
    endCall = () => {
