...
class NotifService {
  ...
  localNotif(nofiticationInfo) {
    this.lastId++;
    PushNotification.localNotification({
      /* Android Only Properties */
      id: ''+this.lastId, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
      ticker:  nofiticationInfo.title || ' ', // (optional)
      autoCancel: true, // (optional) default: true
      largeIcon: "ic_launcher", // (optional) default: "ic_launcher"
      smallIcon: "ic_notification", // (optional) default: "ic_notification" with fallback for "ic_launcher"
      bigText: nofiticationInfo.message || ' ', // (optional) default: "message" prop
      // subText: "This is a subText", // (optional) default: none
      color: "red", // (optional) default: system default
      vibrate: true, // (optional) default: true
      vibration: 300, // vibration length in milliseconds, ignored if vibrate=false, default: 1000
      tag: nofiticationInfo.tag || 'MEDFLIC', // (optional) add tag to message
      group: nofiticationInfo.group || 'Medflic', // (optional) add group to message
      ...
      title: nofiticationInfo.title || ' ', // (optional)
      message: nofiticationInfo.message || 'Medflic Notification', // (required)
      playSound: true, // (optional) default: true
      soundName: nofiticationInfo.sound || 'default', // (optional) Sound to play when the notification is shown. Value of 'default' plays the default sound. It can be set to a custom sound such as 'android.resource://com.xyz/raw/my_sound'. It will look for the 'my_sound' audio file in 'res/raw' directory and play it. default: 'default' (default sound is played)
      number: ''+ this.lastId, // (optional) Valid 32 bit integer specified as string. default: none (Cannot be zero)
      actions: nofiticationInfo.actions || ''  // (Android only) See the doc for notification actions to know more
    });
  }
