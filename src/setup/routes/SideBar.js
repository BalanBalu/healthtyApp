...
class SideBar extends React.Component {
  ...
  render() {
    ...
    return (
      <Container>
        <Content>
          <View style={{height: 120, backgroundColor: primaryColor}}>
            <FastImage
              square
              source={require('../../../assets/images/Logo.png')}
              style={{
                ...
                {hasLoggedIn ? (
                  <View style={{marginLeft: 10}}>
                    <Text
                      ...
                      {this.activeUserData &&
                        this.activeUserData.first_name +
                          ' ' +
                          this.activeUserData.last_name}
                    </Text>
                    <TouchableOpacity
          ...
          <FlatList
            ...
            renderItem={({item}) =>
              item.menuForCorporateUser === true &&
              is_corporate_user === false ? null : (
                <View>
                  <ListItem
                    onPress={() =>
                      item.routeName
          ...
          <View style={{marginTop: 10, marginLeft: 2}}>
            <ListItem avatar style={{marginTop: -15}}>
              ...
              <Body style={{borderBottomWidth: 0}}>
                <Text
                  onPress={() => this.signInOrSignup(hasLoggedIn)}
                  style={{fontFamily: 'OpenSans', fontSize: 15}}>
                  {hasLoggedIn ? translate('Sign Out') : translate('Sign In')}
                </Text>
              </Body>
            </ListItem>
          </View>
