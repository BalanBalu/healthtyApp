...
<Text style={termsStyles.normalText}>
The Content that you obtain or receive from Medflic, its employees, contractors, partners, sponsors, advertisers, licensors or otherwise through the Services, is for informational, scheduling and payment purposes only. All medically related information, including, without limitation, information shared via Medflic Answers, the Medflic blog, Medflic social channels, Medflic emails and text messages, and Medflic advertising, comes from independent healthcare professionals and organizations and is for informational purposes only.
          </Text>
...
<Text style={termsStyles.normalText}>
Medflic or its designee takes certain limited steps to (a) verify that Healthcare Providers participating in the Services hold certain active licenses, certifications or registrations required by law to practice the specialties of the services offered by them through the Services, and (b) verify that Healthcare Providers are not listed in the Indian Department of Health and Human Services Office of the Inspector General Exclusion database.Medflic may also exclude Healthcare Providers from our Services who, in Medflic’s discretion, have engaged in inappropriate or unprofessional conduct.
          </Text>
          <Text style={termsStyles.normalText}>
Some Healthcare Providers listed through the Services enter into contracts with us, and may pay us a fee in order to be marketed through or to use the Services. To help you find Healthcare Providers who may be suitable for your needs, and enable the maximum choice and diversity of Healthcare Providers participating in the Services, we will provide you with lists and/or profiles of Healthcare Providers. These results are based on information that you provide to us, such as insurance information, geographical location, and healthcare specialty. They may also be based on other criteria (including, for example, Healthcare Provider availability, past selections by and/or ratings of Healthcare Providers by you or by other Medflic users, and past experience of Medflic users with Healthcare Providers). Note that Medflic (a) does not recommend or endorse any Healthcare Providers, (b) does not make any representations or warranties with respect to these Healthcare Providers or the quality of the healthcare services they may provide, and (c) does not receive any additional fees from Healthcare Providers for featuring them (i.e., higher or better placement on lists) through the Services (subject to Sponsored Results as described below). Note, however, to the extent that you use the Services as provided by your employer, Medflic may provide lists and/or profile previews based also on criteria determined by your employer and your employer’s agents or advisors. In addition, to the extent that Medflic serves as a platform for, or provides technical support to, the provider directory associated with your health coverage, Healthcare Providers will appear in the directory based on criteria determined by your health plan or plan sponsor, as applicable. We may show you advertisements or sponsored results (“Sponsored Results”)on the Site, including above the search results. Medflic receives additional fees from Healthcare Providers for providing Sponsored Results. Sponsored Results shown through the Services are not, and should not be considered, an endorsement or recommendation by Medflic of the Healthcare Provider.
          </Text>

          <H3 style={termsStyles.mainHeading}>5. THE SERVICES AND CONTENT ARE INFORMATIONAL AND EDUCATIONAL RESOURCES
</H3>  
<Text style={termsStyles.normalText}>
The Services are an informational and educational resource for consumers and Healthcare Providers. We may, but have no obligation to, publish Content through the Services that is reviewed by our editorial personnel. No party (including Medflic) involved in the preparation or publication of such works guarantee that the Content is timely, accurate or complete, and they will not be responsible or liable for any errors or omissions in, or for the results obtained from the use of, such Content.
          </Text>
          <Text style={termsStyles.normalText}>
          Healthcare Provider Content:
</Text>
<Text style={termsStyles.normalText}>
Healthcare Provider and practice Content is intended for general reference purposes only. Healthcare Provider Content may be provided by the Healthcare Provider and/or office staff and collected from multiple other data sources that may not be confirmed by the Healthcare Provider. Such Content can change frequently and may become out of date, incomplete or inaccurate. Neither the Site nor Medflic provides any advice or qualification certification about any particular Healthcare Provider.
</Text>
<Text style={termsStyles.normalText}>
...
<Text style={termsStyles.normalText}>
Protecting patient privacy and keeping your information secure are among our biggest priorities. Our Privacy Policy,  details how we may use, share, and maintain the information that you voluntarily share with Medflic, which may include, without limitation, your name, address, social security number and contact information, insurance information, medical history and current medical needs, billing information, and other personally identifiable information (collectively, “Personal Information”). You may elect to enter information into a medical history form (“Medical History Form”) on behalf of yourself or a third party from whom you have authorization to provide such information. You can request (and in doing so, authorize) Medflic to provide this information to your chosen Healthcare Provider. You acknowledge and agree that such information will be reviewed and approved by you or someone authorized by you at the time of your appointment to ensure its accuracy. You also acknowledge that Medflic may use the data or information you provide in a Medical History Form in accordance with our Privacy Policy.
          </Text>
         ...
         <Text style={termsStyles.normalText}>
         When you create a Medflic account, you will provide an email address and create a password (collectively, “Credentials”). You should keep your Credentials private and not share your Credentials with anyone else. You must immediately notify us if your password has been stolen or compromised by sending an email to service@medflic.com. You may not able to connect to the Services through a third party service, such as Facebook or Google. Medflic has no control over, and assumes no responsibility for, the content, accuracy, privacy policies, or practices of or opinions expressed by any such third party.
</Text>
< Text style={termsStyles.normalTextWithBold}>
...
7.3 Responsibilities of Healthcare Providers and Others in the Healthcare or Medical Industries
         ...
         <Text style={termsStyles.normalText}>
         If you are a Healthcare Provider or other person or entity in the healthcare or medical industries, regardless of whether you maintain an account with Medflic or whether you schedule or intend to schedule appointments (including appointments for Designated Provider Services, as defined in the Additional Terms) through the Services, you acknowledge and agree that:
</Text>
<Text style={termsStyles.normalText}>
...
<Text style={termsStyles.normalText}>
We may from time to time add new features to the Services, substitute a new service for one of the existing Services, or discontinue or suspend one of the existing Services. Under no circumstances will Medflic be liable for any suspension or discontinuation of any of the Services or portion thereof, and the use of new services will be governed by this Agreement.
</Text>
...
<Text style={termsStyles.normalText}>
By posting Posted Information through the Services, you agree to and hereby do grant, and you represent and warrant that you have the right to grant, to Medflic and its contractors an irrevocable, perpetual, royalty-free, fully sublicensable, fully paid up, worldwide license to use, copy, publicly perform, digitally perform, publicly display, and distribute such Posted Information and to adapt, edit, translate, prepare derivative works of, or incorporate into other works, such Posted Information.
</Text>

<H3 style={termsStyles.mainHeading}>11. YOUR USE OF CONTENT
          </H3>  
          <Text style={termsStyles.normalText}>
          All of the Content is owned by us or our licensors and is protected by copyright, trademark, patent, and trade secret laws, other proprietary rights, and international treaties. You acknowledge that the Services and any underlying technology or software used in connection with the Services contain Medflic’s proprietary information. We give you permission to use the Content for personal, non-commercial purposes only and do not transfer any intellectual property rights to you by virtue of permitting your use of the Services. You may print, download, and store information from the Site for your own convenience, but you may not copy, distribute, republish (except as permitted in this paragraph), sell, or exploit any of the Content, or exploit the Site or Services in whole or in part, for any commercial gain or purpose whatsoever. Except as expressly provided herein, neither Medflic nor its suppliers grant you any express or implied rights, and all rights in the Site and the Services not expressly granted by Medflic to you are retained by Medflic.
</Text>
...
<Text style={termsStyles.normalText}>
This Agreement and any supplemental terms, policies, rules and guidelines posted through the Services, each of which are incorporated herein by reference, including the Privacy Policy, the Acceptable Use Policy and the Additional Terms, constitute the entire agreement between you and us and supersede all previous written or oral agreements. If any part of this Agreement is held invalid or unenforceable, that portion shall be construed in a manner consistent with applicable law to reflect, as nearly as possible, the original intentions of the parties, and the remaining portions shall remain in full force and effect. The failure of Medflic to exercise or enforce any right or provision of this Agreement shall not constitute a waiver of such right or provision. The failure of either party to exercise in any respect any right provided for herein shall not be deemed a waiver of any further rights hereunder.
</Text>
